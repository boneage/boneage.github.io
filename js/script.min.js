...
Math.abs(pt.age-c)||null===c)c=ref[pt.sex].ages[a],g=a;SlyCarousel.activate(g)}};boneage.update=function(){pt.getDOB();ref.getToday();pt.getAge();ref.getAge();pt.getBoneAge();ref.getStDev();boneage.setHint();boneage.report="<b>EXAM:</b> XR Bone Age Study<br><br><b>COMPARISON:</b> [None].<br><br><b>TECHNIQUE:</b> Single frontal view of the left hand and wrist.<br><br><b>FINDINGS:</b><br>Sex: "+pt.sex+"<br>Exam Date: "+ref.today+"<br>Date of Birth: "+pt.DOB+"<br>Chronological Age: "+c(pt.age)+"<br><br>At the chronological age of "+
c(pt.age)+", using the Brush Foundation data, the mean bone age for calculation is "+c(ref.age)+". Two standard deviations at this age is "+2*ref.stdev+" months, giving a normal range of "+c(ref.range.low)+" to "+c(ref.range.high)+" (+/- 2 standard deviations).<br><br>By the method of Greulich and Pyle, the bone age is estimated to be "+c(pt.boneAge)+".<br><br><b>IMPRESSION:</b><br>Chronological Age: "+c(pt.age)+"<br>Estimated Bone Age: "+c(pt.boneAge)+"<br><br>The estimated bone age is "+ref.concl+
